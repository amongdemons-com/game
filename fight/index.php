  ...
  <body class="d-flex flex-column">
    ...
    <main class="container flex-fill d-flex flex-column align-center vh-100 overflow-hidden">
      <div class="row align-items-center">
        <div class="card p-0 my-3 bg-dark-subtle col" id="myDemon">
          <div class="row g-0">
            ...
            <div class="col-12 col-md-6 d-flex flex-column info justify-content-center">
              <div class="card-body">
                <h5 class="card-title">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item bg-dark-subtle">
                  <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="<?php echo $myDemon["hp"];?>" aria-valuemin="0" aria-valuemax="<?php echo $myDemon["maxhp"];?>" style="height: 3em;">
                    <div class="progress-bar bg-success" style="width: <?php echo 100*$myDemon["hp"]/$myDemon["maxhp"];?>%"></div>
                  </div>
                </li>
        ...
        <div class="col text-center fs-3 px-2 px-md-5" style="flex:0;">VS</div>
        <div class="card p-0 my-3 bg-dark-subtle col" id="enemyDemon">
          <div class="row g-0">
            <div class="col-12 col-md-6 d-flex flex-column info justify-content-center">
              <div class="card-body">
                <h5 class="card-title">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item bg-dark-subtle">
                  <div class="row p-0">
                    ...
                    <div class="text-center col-12 col-xl-6 p-0">
                      <span class="hp"><?php echo $enemyDemon["hp"];?></span> / <span class="maxhp"><?php echo $enemyDemon["maxhp"];?></span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 384 512" class="mb-1"><defs></defs><path class="fa-secondary" d="M192 512C86 512 0 426 0 320C0 228.8 130.2 57.7 166.6 11.7C172.6 4.2 181.5 0 191.1 0h1.8c9.6 0 18.5 4.2 24.5 11.7C253.8 57.7 384 228.8 384 320c0 106-86 192-192 192zM96 336c0-8.8-7.2-16-16-16s-16 7.2-16 16c0 61.9 50.1 112 112 112c8.8 0 16-7.2 16-16s-7.2-16-16-16c-44.2 0-80-35.8-80-80z"/><path class="fa-primary" d="M80 320c8.8 0 16 7.2 16 16c0 44.2 35.8 80 80 80c8.8 0 16 7.2 16 16s-7.2 16-16 16c-61.9 0-112-50.1-112-112c0-8.8 7.2-16 16-16z"/></svg>
                    </div>
                  </div>
                </li>
                <li class="list-group-item bg-dark-subtle">
                  <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="<?php echo $enemyDemon["hp"];?>" aria-valuemin="0" aria-valuemax="<?php echo $enemyDemon["maxhp"];?>" style="height: 3em;">
                    <div class="progress-bar bg-success" style="width: <?php echo 100*$enemyDemon["hp"]/$enemyDemon["maxhp"];?>%"></div>
                  </div>
                </li>
                <li class="list-group-item bg-dark-subtle"></li>
              </ul>
              <div class="px-3 pb-3 text-center">
                <button type="button" class="btn btn-success btn-sm py-1 ps-2 pe-2" id="fight">
                  Fight
